    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			<?php echo"<form method='post' action='php/postar.php?user=vezio' enctype='multipart/form-data'>"; ?> 
				...
				<input type="submit" class="btn btn-success forms formz" value="Postar" />
        </div>
			</form>
        </div>
      </div>
